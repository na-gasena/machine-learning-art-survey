...
### 提案する機械: Living Archive

Wayne McGregorとGoogle Arts & Culture Labの*Living Archive*（2019）は、25年分の振付映像と現役ダンサーの動きを学習し、数秒の入力に対して複数の次動作候補を提示しました。ダンサーは出力を複製せず、身体的に解釈します。協働は「半分ずつ作る」ことではなく、提案、拒否、翻訳の反復として観察できます。[Studio Wayne McGregor](https://waynemcgregor.com/productions/living-archive/) ・ [詳細解説](https://artsandculture.google.com/story/living-archive-creating-choreography-with-artificial-intelligence-studio-wayne-mcgregor/1AUBpanMqZxTiQ?hl=en)

### 見る機械: discrete figures

Rhizomatiks Research、ELEVENPLAY、Kyle McDonaldによる*discrete figures*（2018）は、機械学習、OpenPose、CGの仮想ダンサー、実演を同じ舞台へ置きます。身体はモデルへ入力される骨格であると同時に、モデル化からこぼれる重さ、疲労、同期のずれを持つ実演です。[公式作品ページ](https://research.rhizomatiks.com/s/works/discrete_figures) ・ [文化庁メディア芸術祭](https://j-mediaarts-festival.bunka.go.jp/en/award/single/discrete-figures/index-2.html)

### 台詞を渡す機械: Improbotics

Improboticsでは、生成された台詞がイヤホン経由で俳優へ送られます。俳優の身体、声、相手への注意が、文脈の薄い文を舞台上の行為へ変えます。これは機械の自律性を示すより、意味生成における人間の修復労働を可視化します。[公式](https://improbotics.org/) ・ [研究論文](https://doi.org/10.1609/aiide.v14i1.13030)

### 身体を得るモデル: Alter3とAndroid Opera

東京大学のAlter3研究は、GPT-4の言語表現をアンドロイドの動作へ接地し、テキストから身体運動を生成します。渋谷慶一郎のAndroid Opera *Scary Beauty*と後続作では、Alter系アンドロイドの歌唱、指揮、即興的反応が人間の演奏者と並びます。研究用身体と舞台上のキャラクターを区別しつつ、同じプラットフォームが両方に関わる点を追います。

- [Alter3論文](https://arxiv.org/abs/2312.06571)
- [Android Opera公式アーカイブ](https://atak.jp/works/android-opera-scary-beauty/)

### 共生種としての機械: In Love With the World

Anicka YiのTate Modern委嘱作は、空中を移動するaerobesを道具や人型ロボットとしてではなく、感覚と群行動を持つ機械種として提示しました。ここで協働は制作机上の共同作業ではなく、人、機械、匂い、空気、建築が同じ環境を共有する問題になります。[公式発表](https://www.hyundai.com/worldwide/en/newsroom/detail/0000000456)

## 協働の記録方法

協働作品を比較する際は、最終出力だけでなく、誰が提案し、誰が選び、拒否できたか、遅延や誤りを誰が修復したか、学習データを誰が提供したかを記録します。ライブ作品では、リハーサル、オペレーター、フェイルセーフ、安全管理、観客の同意も作者性の一部です。
...
- [批評、権利、来歴]({{ '/ja/topics/critique-rights-provenance/' | relative_url }}) - 声、身体、スタイルの同意と統治
